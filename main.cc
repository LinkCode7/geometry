...
#pragma region 测试凸多边形
    ...
    {
        constexpr double coordinate[][2] = {{12.7012, -637.599}, {-100.763, -594.415}, {-135, -508}, {-118, -413}, {10, -350},
...

    {
        constexpr double coordinate[][2] = {
            {128.562, 84.9289}, {192.454, 59.9957}, {264.137, 70.1248}, {360.753, 83.3706}, {399.711, 113.758}, {469.057, 150.379},
            {514.249, 150.379}, {571.907, 183.104}, {604.632, 226.737}, {610.086, 275.824}, {610.865, 337.378}, {568.79, 403.607},
            {544.636, 413.736}, {458.928, 420.749}, {410.62, 411.399},  {338.157, 381.011}, {187.779, 343.612}, {150.379, 324.912},
            {98.9539, 293.745}, {97.3956, 216.608}, {137.133, 158.17},  {129.341, 112.979}, {115.316, 104.408}};
        bg::assign_points(geometryPolygon2d, coordinate);
        bg::append(geometryPolygon2d.outer(), point_2d({coordinate[0][0], coordinate[0][1]}));
    }
    geometryPolygon2dVec.emplace_back(geometryPolygon2d);
...
#pragma region 测试凹多边形
    ...
    //{
    //    const double coordinate[][2] = {{223.743, -455.054}, {224.414, -398.64},  {174.226, -402.224}, {176.376, -358.489}, {226.565,
    //    -360.64},
    ...
    //{
    //    const double coordinate[][2] = {{320.64, -448.633},  {291.611, -447.313}, {294.91, -420.923},  {246.088, -421.583}, {255.325,
    //    -377.379},
    ...
    //{
    //    const double coordinate[][2] = {{113.607, 79.1648}, {147.534, 39.0683}, {152.161, 85.3334}, {224.643, 86.8756}, {187.631,
    //    132.627},
    ...
    //{
    //    const double coordinate[][2] = {{83.2379, 64.8027}, {100.556, 27.9322}, {128.488, 74.8582}, {185.47, 69.2718},  {152.51, 110.053},
    ...
    //{
    //    const double coordinate[][2] = {{191.104, 96.0249}, {156.573, 59.1286}, {104.539, 69.5352}, {116.365, 94.1327}, {63.8589, 118.73},
...
#pragma endregion
    ...
    {
        std::cout << "Index: " << i << " (x0: " << bg::get<0>(geometrycrossPointVec[i]) << ", y0: " << bg::get<1>(geometrycrossPointVec[i])
                  << ") (x1: " << bg::get<0>(sweepLinecrossPointVec[i]) << ", y1: " << bg::get<1>(sweepLinecrossPointVec[i]) << ")"
                  << std::endl;

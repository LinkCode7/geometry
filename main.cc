...
#pragma endregion
    ...
    point2d_unordered_set GeometrycrossPointSet  = TestBoostGeometry(geometryPolygon2dVec);
    point2d_unordered_set SweepLinecrossPointSet = TestSweepLine(geometryPolygon2dVec);
